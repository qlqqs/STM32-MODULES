...
typedef struct {
    ...
    int16_t step_angle;           /* 每步角度变化 */
    uint16_t step_delay_ms;       /* 每步延时（毫秒） */
    uint16_t current_delay;       /* 当前延时计数 */
