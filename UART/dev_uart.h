...
/******************* 移植需要修改的函数声明 ******************/
int uart1_print(const char *str);                                                           /* 串口1直接打印字符串 */
int uart1_printf(const char *format, ...);                                                  /* 串口1格式化打印 */
uint16_t uart1_read(uint8_t *buf);                                                          /* 串口1读取数据 */
int uart3_print(const char *str);                                                           /* 串口3直接打印字符串 */
int uart3_printf(const char *format, ...);                                                  /* 串口3格式化打印 */
int uart4_print(const char *str);                                                           /* 串口4直接打印字符串 */
int uart4_printf(const char *format, ...);                                                  /* 串口4格式化打印 */
int uart5_print(const char *str);                                                           /* 串口5直接打印字符串 */
