...
void DMA1_Stream0_IRQHandler(void)
{
  /* USER CODE BEGIN DMA1_Stream0_IRQn 0 */
    if(__HAL_DMA_GET_FLAG(&hdma_uart5_rx, DMA_FLAG_TCIF0_4))
    {
        __HAL_DMA_CLEAR_FLAG(&hdma_uart5_rx, DMA_FLAG_TCIF0_4);
        uart_dmarx_done_isr(5);
    }
...
void DMA1_Stream1_IRQHandler(void)
{
  /* USER CODE BEGIN DMA1_Stream1_IRQn 0 */
    if(__HAL_DMA_GET_FLAG(&hdma_usart3_rx, DMA_FLAG_TCIF1_5))
    {
        __HAL_DMA_CLEAR_FLAG(&hdma_usart3_rx, DMA_FLAG_TCIF1_5);
        uart_dmarx_done_isr(3);
    }
...
void DMA1_Stream4_IRQHandler(void)
{
  /* USER CODE BEGIN DMA1_Stream4_IRQn 0 */
    if(__HAL_DMA_GET_FLAG(&hdma_uart4_tx, DMA_FLAG_TCIF0_4))
    {
        __HAL_DMA_CLEAR_FLAG(&hdma_uart4_tx, DMA_FLAG_TCIF0_4);
        uart_dmatx_done_isr(4);
    }
...
void DMA1_Stream7_IRQHandler(void)
{
  /* USER CODE BEGIN DMA1_Stream7_IRQn 0 */
    if(__HAL_DMA_GET_FLAG(&hdma_uart5_tx, DMA_FLAG_TCIF3_7))
    {
        __HAL_DMA_CLEAR_FLAG(&hdma_uart5_tx, DMA_FLAG_TCIF3_7);
        uart_dmatx_done_isr(5);
    }
